...
mod tests {
    ...
    fn test_parameter_parm_wrapped_on_pack() {
        ...
        assert_eq!(stored_crc, 0xc89c2297, "PARM CRC must match the vendor polynomial");
    }
    ...
    fn test_pre_wrapped_parameter_is_not_wrapped_again() {
        ...
        // Generated by the vendor-compatible 0x04C11DB7 polynomial used by
        // the external repack script from issue #19.
